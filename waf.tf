# AWS WAF WebACL for ALB and CloudFront protection

# WAF WebACL for Regional Resources (ALB)
resource "aws_wafv2_web_acl" "regional" {
  ...
  visibility_config {
    cloudwatch_metrics_enabled = true
    metric_name                = "${local.name_prefix}-regional-waf-metric"
    sampled_requests_enabled   = true
  }
...
resource "aws_wafv2_web_acl" "cloudfront" {
  ...
  visibility_config {
    cloudwatch_metrics_enabled = true
    metric_name                = "${local.name_prefix}-cloudfront-waf-metric"
    sampled_requests_enabled   = true
  }
